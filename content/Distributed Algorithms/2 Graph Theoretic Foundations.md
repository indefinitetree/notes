...
$$
\displaystyle{\begin{aligned}|A| \geq \dfrac{|V|}{d+1} \end{aligned}}
$$
Since $|X'| = |V| - |A|$ , therefore 
$$
\displaystyle{\begin{aligned}|X'| \leq \dfrac{d}{d+1} |V|\end{aligned}}
$$
Previously, we had $|V| \leq (d+1) \cdot |Y|$ . Combining these two, we get
$$
\displaystyle{\begin{aligned}|X'| \leq d \cdot |Y|\end{aligned}}
$$
